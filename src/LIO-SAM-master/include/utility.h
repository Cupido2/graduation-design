...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>("lio_sam/gpsFixTopic", gpsFixTopic, "/navsat/fix");
        ...
        // // KITTI的64线
        // nh.param<int>("lio_sam/N_SCAN", N_SCAN, 64);
        // nh.param<int>("lio_sam/Horizon_SCAN", Horizon_SCAN, 2083);
