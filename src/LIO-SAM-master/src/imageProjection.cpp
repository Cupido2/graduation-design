...
public:
    ...
    void imuHandler(const sensor_msgs::Imu::ConstPtr& imuMsg)
    {
        ...
        // 位姿输出到txt文档
        // std::ofstream pose1("/home/cupido/imu_vec.txt", std::ios::app);
        ...
        // static double timeStart = currentImuTime;
        // pose1 << currentImuTime - timeStart  << " "
        //       << thisImu.linear_acceleration.x << " "
        //       << thisImu.linear_acceleration.y << " "
        //       << thisImu.linear_acceleration.z << std::endl;

        // pose1.close();

        // // 位姿输出到txt文档
        // std::ofstream pose1("/home/cupido/imu_data.txt", std::ios::app);
        // pose1.setf(std::ios::scientific, std::ios::floatfield);
        // pose1.precision(15);
